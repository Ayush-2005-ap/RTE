...
const posts = [
  ...
  { slug: 'how-to-file-rte-grievance', title: 'Step-by-Step: How to File an RTE Grievance That Actually Gets Resolved', excerpt: 'A practical guide on documenting violations, choosing the right authority to approach, and following up for resolution.', author: 'Advocate Sunita Rao', readTime: '6 min read', date: 'Feb 20, 2025', tags: ['Grievances', 'Action Guide'], isFeatured: false },
